...
setupAddPrimaryTable("patient", keyColumnName = "patient_id", whereMarkers = [primaryTableWhereStatement])
...
setupAddPrimaryTable("site_source", columnNames = ["name"], keyColumnName = "site_source")
